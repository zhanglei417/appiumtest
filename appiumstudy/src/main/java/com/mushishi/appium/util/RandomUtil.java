package com.mushishi.appium.util;
...
//        int s = random.nextInt(max)%(max-min+1) + min;
	 ...
	 */
	public static String getInt(String str,int index){
...
//		System.out.println("0"+getRndNumByLen(3));
		System.out.println(getInt("appium -p 4490 -bp 2253 -U 127.0.0.1:62001>logs/127.0.0.1:62001.log",0));
	}
