package com.mushishi.appium.datadriver;
...
import com.mushishi.appium.page.BasePage;
...
public class KeyWordsAction {
	...
	public void input(String locator,String inputValue) {
		...
		try {
			driver.findElement(GetByLocator.getLocator(locator)).sendKeys(inputValue);
		} catch (Exception e) {
	...
	public void  Assert_Element(String string,String assertString)  {
		try{ 
	 ...
	 * 获取list
	 * */
	public void getListElement(String locator){
		List listElement = driver.findElements(GetByLocator.getLocator(locator));
